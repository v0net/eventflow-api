...
The project demonstrates a layered architecture, JWT authentication, transactional booking logic, asynchronous database access, database migrations, and automated API testing.
...
* **Testing** — an integration test covering the full auth-and-booking flow, using pytest, pytest-asyncio, and HTTPX against an in-memory SQLite database.
...
```bash
git clone https://github.com/v0net/eventflow-backend.git
...
Portfolio project demonstrating asynchronous backend development, relational data modeling, transactional integrity, and containerized development practices.
...
Проект демонстрирует слоистую архитектуру, JWT-аутентификацию, транзакционную логику бронирования, асинхронный доступ к БД, миграции схемы и автоматизированное тестирование API.
...
* **Тестирование** — интеграционный тест, покрывающий полный сценарий аутентификации и бронирования, на pytest, pytest-asyncio и HTTPX с in-memory SQLite.
...
Портфолио-проект, демонстрирующий асинхронную backend-разработку, реляционное моделирование данных, транзакционную целостность и практики контейнеризированной разработки.
